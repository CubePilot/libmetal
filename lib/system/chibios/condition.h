...
/*
 * @file	chibios/condition.h
 * @brief	Chibios condition variable primitives for libmetal.
 */

#ifndef __METAL_CONDITION__H__
#error "Include metal/condition.h instead of metal/chibios/condition.h"
#endif

#ifndef __METAL_CHIBIOS_CONDITION__H__
#define __METAL_CHIBIOS_CONDITION__H__
...
#endif /* __METAL_CHIBIOS_CONDITION__H__ */
